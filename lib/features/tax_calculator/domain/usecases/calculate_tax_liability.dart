...
class CalculateTaxLiability {
  ...
  TaxAssessment execute(TaxProfile profile) {
    ...
    // The 9% high-income surcharge applies to salaried tax for 2025-26 onward.
    if (profile.type == TaxProfileType.salaried &&
        annualGross > 10000000 &&
        _endingTaxYear(profile.taxYear) >= 2026) {
      annualTaxBeforeAdjustments = (annualTaxBeforeAdjustments * 1.09)
          .roundToDouble();
    }
  ...
  double _computeSalariedProgressiveTax(
    ...
    final taxYear = _endingTaxYear(taxYearString);
  ...
  int _endingTaxYear(String taxYearString) {
    // Fiscal year '2025-26' corresponds to the ending tax year 2026.
...
const _salariedSlabs2019 = [
  ...
  _TaxSlab(upperLimit: 1240000, fixedTax: 2000, excessOver: 1200000, rate: 0),
  _TaxSlab(upperLimit: 2500000, fixedTax: 0, excessOver: 1200000, rate: 0.05),
  _TaxSlab(
    upperLimit: 4000000,
    fixedTax: 65000,
    excessOver: 2500000,
